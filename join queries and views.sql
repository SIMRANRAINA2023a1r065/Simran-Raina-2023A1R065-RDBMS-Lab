...
# note execute these command on university database that i have shared 
...
ADD CONSTRAINT `instructor_manager`
  FOREIGN KEY (`mid`)
  REFERENCES `university`.`instructors` (`InstructorID`)
  ON DELETE SET NULL
  ON UPDATE SET NULL;

UPDATE `university`.`instructors` SET `mid`='1' WHERE `InstructorID`='2';
UPDATE `university`.`instructors` SET `mid`='3' WHERE `InstructorID`='4';
UPDATE `university`.`instructors` SET `mid`='5' WHERE `InstructorID`='6';
UPDATE `university`.`instructors` SET `mid`='7' WHERE `InstructorID`='8';
UPDATE `university`.`instructors` SET `mid`='9' WHERE `InstructorID`='10';
UPDATE `university`.`instructors` SET `mid`='11' WHERE `InstructorID`='12';
UPDATE `university`.`instructors` SET `mid`='13' WHERE `InstructorID`='14';
UPDATE `university`.`instructors` SET `mid`='15' WHERE `InstructorID`='16';
UPDATE `university`.`instructors` SET `mid`='17' WHERE `InstructorID`='18';
UPDATE `university`.`instructors` SET `mid`='19' WHERE `InstructorID`='20';
